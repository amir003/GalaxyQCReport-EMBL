...
public class GenerateNGSQCReportAfterGalaxyWF {
	...
	//private static Logger log = Logger.getLogger(GenerateNGSQCReportAfterGalaxyWF.class);
	...
	public static void main(String[] args){
		//log.debug("TEEEESSSSTTTTT");
		
		if((args == null)||(args.length == 0)){
			System.err.println("Please enter the correct pathname of your directory as argument.");
		...
		/*
		File existSubDir1 = new File(qcDirPath,"fastqc");
		File existSubDir2 = new File(qcDirPath,"alignment-metrics");
		File existSubDir3 = new File(qcDirPath,"read_duplication-metrics");
		File existSubDir4 = new File(qcDirPath,"SPP");
		
		if (! ( (existSubDir1.isDirectory()) || (existSubDir2.isDirectory()) || (existSubDir3.isDirectory()) || (existSubDir4.isDirectory()) ) ){
			
			System.out.println("Wrong directory. Please, enter the good path of your directory.");
			//System.exit(1);
		...
		*/
		...
		try {
			...
			System.err.println("Execution failed, please check above error message.");
			System.exit(1);
		}
	...
	private void copySupportFiles() throws IOException {
		...
		if (GenerateNGSQCReportAfterGalaxyWF.class.getResourceAsStream("dataTable/images/") != null){
